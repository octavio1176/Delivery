...
public class EmailService {
    ...
    <body style="font-family: Arial, sans-serif; background:#f4f4f4; padding:40px;">
        ...
        <div style="max-width:600px; margin:auto; background:white; padding:30px;
            ...
            <p>Recebemos seu pedido <strong>#%d</strong> e já estamos preparando tudo. 🍔</p>
            ...
            <table style="width:100%%; border-collapse:collapse; margin:25px 0;">
                <thead>
                    <tr style="background:#2c3e50; color:white;">
                        ...
                        <th style="padding:10px; text-align:right;">Preço (MT)</th>
                        <th style="padding:10px; text-align:right;">Subtotal (MT)</th>
                    </tr>
                </thead>
                <tbody>
                    %s
            ...
            <p style="margin-top:30px;">Status atual: <strong>%s</strong></p>
